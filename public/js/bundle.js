...
/* eslint-disable */
var addPointToMap = function addPointToMap(map, bounds, loc, color) {
  // Create marker
  var el = document.createElement('div');
  el.className = "marker marker-".concat(color); // Add marker
...
var displayMap = function displayMap(startLocation, locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieXV2YWwtc2hsb21vIiwiYSI6ImNrYzBrb3dsMzFrdGEyd214azQxNDU5ZHMifQ.2xUoYrGPv6At95HdJ2RI0w';
  ...
  locations.forEach(function (loc) {
    return addPointToMap(map, bounds, loc, 'green');
  });
...
var stripe = Stripe('pk_test_51H0OxkJAywHFHGhe8S7CX98lefADC3PPFyVtWdI5tJWArBtUnTellj4LGFCqLgRsZbFww1OmSwsHxxSDr7GB9iLY00BYdYnYJw');
...
if (mapBox) {
  var startLocation = JSON.parse(mapBox.dataset.startlocation);
  var locations = JSON.parse(mapBox.dataset.locations);
  (0, _mapbox.displayMap)(startLocation, locations);
}
